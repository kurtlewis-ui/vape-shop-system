...
import type { ApiEnvelope, RoleOption } from '@/lib/types';
...
export function AddStaffModal({ open, onClose, roles }: AddStaffModalProps) {
  ...
  const mutation = useMutation({
    mutationFn: async () => {
      const response = await api.post<ApiEnvelope<unknown>>('/users', {
        firstName,
        lastName,
        email,
        password,
